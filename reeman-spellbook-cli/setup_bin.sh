...
echo "==========================================="
echo "Reeman Spellbook — Setup bin directory"
echo "==========================================="
...
echo ""
echo "To activate:"
echo "  source activate_reeman.sh"
echo ""
echo "You'll be able to run: reeman_help, navigate, get_maps, ..."
echo ""
echo "To deactivate:"
echo "  deactivate_reeman"
echo ""
